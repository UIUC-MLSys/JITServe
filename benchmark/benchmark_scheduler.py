...
from trace.client import (client_simulator, send_request, send_collective_request,
                   RequestInput, TaskOutput, RequestOutput)
from trace.trace import Trace, BaseDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--trace-path",
        type=str,
        default="benchmark/trace/dataset/trace/lmsys.json",
