...
from trace.trace_deepresearch import (
    DeepResearchTrace, DeepResearchCollectiveRequest)
from trace.client_deepresearch import (
    deepresearch_client_simulator, CollectiveOutput)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--trace-path",
        type=str,
        # default="benchmark/trace/dataset/trace/deepresearch_trace_filtered_8192.jsonl",
        default="benchmark/trace/dataset/trace/test_deepresearch_llama3_maxout1024_filtered8192.jsonl",
