...
def main():
    ...
    # Load original trace
    trace_root = Path(__file__).resolve().parents[1].parents[1]
    trace_path = os.path.join(trace_root, 'traces', 'lmsys.json')
    ...
    output_path = os.path.join(trace_root, 'traces', output_filename)
