...
from vllm.slo_tracker.request_info import RequestType, RequestInfo, RequestConcordMetrics
...
class SequenceGroup:
    ...
    def __init__(
        ...
        for seq in self.seqs:
            seq.real_output_len = request_info.real_output_len
